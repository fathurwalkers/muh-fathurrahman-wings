...
class DatabaseSeeder extends Seeder
{
    public function run()
    {
        ...
        // Example User Login
        $tokenexample = Str::random(16);
        $roleexample = "user";
        $hashPasswordexample = Hash::make('12345', [
            'rounds' => 12,
        ]);
        $hashToken = Hash::make($tokenexample, [
            'rounds' => 12,
        ]);
        Login::create([
            'login_nama' => 'Example User',
            'login_username' => 'example',
            'login_password' => $hashPasswordexample,
            'login_email' => 'exampleuser@gmail.com',
            'login_telepon' => '083457592841',
            'login_token' => $hashToken,
            'login_level' => $roleexample,
            'login_status' => "verified",
            'created_at' => now(),
            'updated_at' => now()
        ]);
